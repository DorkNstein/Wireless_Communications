...
% % THE WORD ERROR ANALYSIS - MADE NO SENSE  
% figure(2)
% plot(sigma,BER_actual_w,'b','LineWidth',2);
% hold on
% %plot(sigma,BER_corrected_w,'g','LineWidth',2);
% plot(sigma,BER_after_corr_w,'--r','LineWidth',2);
% 
% title('\bf HAMMING 7,4 SCHEME : NOISE VARIANCE VS BER - WORDS'...
%         ,'FontSize',18);
% xlabel('\bf Noise Standard deviation (  \sigma )','FontSize',16);
% ylabel('\bf BER - WORDS','FontSize',16);
% h = legend('Actual BER(symbol)','BER after Hamming correction(symbol)',...
%     'Location','NorthWest');
% set(h,'FontSize',16);
% hold off
